...
x_data1 = difference(x_data4, x_data1)
y_data1 = difference(y_data4, y_data1)

x_data2 = difference(x_data4, x_data2)
y_data2 = difference(y_data4, y_data2)

x_data3 = difference(x_data4, x_data3)
y_data3 = difference(y_data4, y_data3)
...
def animate(i):
    ...
    ax.plot(x_axis4, y_axis4, color = "red")
