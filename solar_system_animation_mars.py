...
x_data1 = difference(x_data3, x_data1)
y_data1 = difference(y_data3, y_data1)

x_data2 = difference(x_data3, x_data2)
y_data2 = difference(y_data3, y_data2)

x_data3 = x_data3
y_data3 = y_data3

x_data4 = difference(x_data3, x_data4)
y_data4 = difference(y_data3, y_data4)
...
def animate(i):
    ...
    ax.plot(x_axis3, y_axis3, color = "red")
    ax.plot(x_axis4, y_axis4, color = "black")
    ax.scatter(0, 0, s=25, color = "orange")
    ax.set_xlim([-7,7])
    ax.set_ylim([-7,7])
